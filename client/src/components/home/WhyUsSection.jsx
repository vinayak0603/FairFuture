...
export default function WhyUsSection() {
  ...
  return (
    <motion.section
      ...
      className="w-full bg-[#f8f9fa] py-14 lg:py-20 px-6 md:px-8 lg:px-10 border-t border-slate-100/60 text-slate-900 font-sans"
    >
      <div className="w-full max-w-[1720px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          {/* Right Column: 2 Staggered Feature Columns */}
          <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-0">
            ...
            {/* Rightmost Column (Column 2 of features) */}
